...
class DES():
    ...
    def select_action(self, state):
        ...
        if sample > eps_threshold:
            ...
            return LongTensor([[random.randrange(len(self.available_actions)-1)]])  # return env.action_space.sample()
    ...
    def ExpectedValues(self, batch_state):
        q_values = self.model(batch_state).detach()
...
if __name__ == '__main__':
    ...
    ai_list = [
        (env_being_tested[2],1,0.001,0.99,0.9,0.05,200,64),
        (env_being_tested[2],3,0.001,0.99,0.9,0.05,200,64),
        (env_being_tested[2],5,0.001,0.99,0.9,0.05,200,64)
    ]
    ai_learncurve = []
