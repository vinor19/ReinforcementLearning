...
def run_episode(e, environment):
    ...
    while True:
        ...
        if len(rewardQueue) > N-1:
            memory.push((FloatTensor([stateQueue.pop(0)]),
                        actionQueue.pop(0),  # action is already a tensor
                        FloatTensor([stateQueue[-1]]),
                        FloatTensor([sum(rewardQueue)])))
            rewardQueue.pop(0)
        ...
        if done:
            ...
            if e %100 == 0:
              ...
              print('Average reward fpr 100 episode= {}'.format(episodeSum / 100))
